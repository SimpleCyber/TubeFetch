...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function detectPlatform(url) {
    ...
    if (lower.includes('x.com') || lower.includes('twitter.com')) return { name: 'Twitter / X', color: '#000000', domains: ['.x.com', '.twitter.com'] };
    ...
    if (lower.includes('tiktok.com')) return { name: 'TikTok', color: '#ff0050', domains: ['.tiktok.com'] };
