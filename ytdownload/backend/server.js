...
function getCookieOption(sessionId) {
    ...
    if (isLocal) {
        console.log(`[Cookies] Local environment detected. Note: If Chrome is open, cookie access might fail due to database locks.`);
        // Try to use a profile or just the default. 
        // Edge is often a good fallback on Windows if Chrome is locked.
